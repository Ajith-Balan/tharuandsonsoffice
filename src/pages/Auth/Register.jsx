    ...
    if (name === "ifsccode" && upperIFSC.length === 11) {
      ...
      try {
        const res = await axios.get(
          `${import.meta.env.VITE_APP_BACKEND}/api/v1/worker/get-ifsc/${upperIFSC}`
        );
        setFormData((prev) => ({
          ...prev,
          bank: res.data.BANK,
 ...
 <div>
              ...
              <div>
                ...
                <input
                  ...
                  } rounded-md focus:ring-2 focus:ring-yellow-800 text-sm`}
                />
                {loadingIfsc && (
              ...
              <div>
                ...
                <input
                  ...
                  readOnly
                  value={formData.bank}
                  className="w-full p-2 border border-gray-300 bg-gray-100 rounded-md text-sm"
                />
              </div>
